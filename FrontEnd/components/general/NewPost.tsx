                ...
                <div className="w-full flex flex-col">
                    <Select
                        ...
                        styles={{
                            ...
                            option: (state) => ({ ...state, backgroundColor: 'black', color: 'white' }),
                        }}
                        options={options} />
                    ...
                    <Textarea
                        ...
                        value={text}
                        className="bg-black text-white w-full h-24 p-2 my-2 focus:outline-none focus:ring-0" placeholder="Add text"
                    />

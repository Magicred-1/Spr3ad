...
function PostComponent({ post }: {
    ...
    return (
        <div className="flex flex-col gap-2 rounded-md bg-blue-950 min-h-48 p-2">
            ...
            {post.mediaUrl && (<div className="w-40 h-40 flex items-center justify-center">
                <Image alt={"postImage"} width={350} height={200} style={{ objectFit: 'cover' }} src={post.mediaUrl} className="" />
            </div>)}
